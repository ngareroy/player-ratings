...
import { subscribeAdmins, removeAdmin, subscribePlayers, subscribeClubSettings } from '../firebase'
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 8 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <h1 style={{ color: "#fff", fontSize: 22, fontWeight: 800, margin: 0, letterSpacing: 1 }}>{club.clubName || "Hub FC"} MANAGEMENT</h1>
          </div>
