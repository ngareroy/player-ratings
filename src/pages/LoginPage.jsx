...
import { loginWithEmail, registerWithEmail, loginWithGoogle, getAdminCount, setAdminRole, getAdminRole } from '../firebase'
                    ...
                    {!accessDenied && (
                        <>
                            ...
                            <button onClick={handleEmailLogin} disabled={submitting}
                                ...
                                {submitting ? "Please wait..." : isSetup ? "Create Head Coach Account" : "Sign In"}
                            </button>
