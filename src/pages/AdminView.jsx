...
export default function AdminView() {
    ...
    const enriched = useMemo(() =>
        players.map(p => ({ ...p, cats: calcCategories(p), total: calcOverall(p) }))
        , [players])
    ...
    return (
        <div style={{
            ...
            padding: "20px 12px", fontFamily: "system-ui"
        }}>
            <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                <div style={{
                    ...
                    <span style={{
                        ...
                        color: "#2ecc40", fontSize: 9, fontWeight: 700,
                ...
                <p style={{
                    ...
                    textAlign: "center", margin: "0 0 18px", letterSpacing: 2
                }}>
                ...
                <div style={{
                    ...
                    flexWrap: "wrap", marginBottom: 20, alignItems: "center"
                }}>
                    ...
                    {[{ key: "total", label: "OVR" },
                    ...CAT_ORDER.map((c, i) => ({ key: c, label: CAT_LABELS[i] }))
                    ].map(o => (
                        <button key={o.key} onClick={() => setSortBy(o.key)}
                            style={{
                                background: sortBy === o.key
                                    ? "rgba(46,204,64,0.2)" : "rgba(255,255,255,0.06)",
                                border: sortBy === o.key
                                    ? "1px solid #2ecc40" : "1px solid rgba(255,255,255,0.1)",
                    ...
                    <button onClick={() => setModal({ isNew: true, player: null })}
                        style={{
                            ...
                            border: "none", borderRadius: 8, padding: "7px 16px", color: "#fff",
