...
import { subscribeMatches, subscribePlayers, subscribeMatchStats, subscribeTeams, saveMatchStat, saveMatch } from '../firebase'
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
                        <div>
                            <div style={{ color: "#fff", fontSize: 22, fontWeight: 800 }}>
                                {hasScore ? `Hub FC ${match.goalsFor} — ${match.goalsAgainst} ${match.opponent}` : `Hub FC vs ${match.opponent}`}
                            </div>
                ...
                <div style={{ background: "linear-gradient(145deg,#1a1a2e,#16213e)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.08)", overflow: "hidden", marginBottom: 16 }}>
                    <div style={{ padding: "16px 20px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <button onClick={handleSaveAll} disabled={saving}
                            style={{ background: "linear-gradient(135deg,#1a6b1a,#2ecc40)", border: "none", borderRadius: 8, padding: "8px 20px", color: "#fff", fontSize: 12, fontWeight: 700, cursor: saving ? "wait" : "pointer", opacity: saving ? 0.6 : 1 }}>
